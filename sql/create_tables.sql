...
CREATE TABLE IF NOT EXISTS `jeux` (
  ...
  `full_titre` text COLLATE utf8_general_ci,
  `image_fond` text COLLATE utf8_general_ci,
  `couverture` text COLLATE utf8_general_ci,
  `is_public` tinyint(1) DEFAULT NULL,
  `description` text COLLATE utf8_general_ci,
  `main_page_url` text COLLATE utf8_general_ci,
  PRIMARY KEY (`index`),
...
CREATE TABLE IF NOT EXISTS `cartes` (
  ...
  `image_fond` text COLLATE utf8_general_ci,
  `deco_style` text COLLATE utf8_general_ci,
  `deco_style_params` text COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `points` (
  ...
  `model_params` text COLLATE utf8_general_ci NOT NULL,
  `x_size` int(11) DEFAULT NULL,
  `y_size` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  `index` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_name` text COLLATE utf8_general_ci,
  `user_right` int(11) unsigned DEFAULT NULL,
  `user_mail` text COLLATE utf8_general_ci,
  `userMaps` text COLLATE utf8_general_ci,
  `user_psw` text COLLATE utf8_general_ci,
  PRIMARY KEY (`index`),
