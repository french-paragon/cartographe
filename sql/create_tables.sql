...
##tables for users sessions

CREATE TABLE IF NOT EXISTS users
(`index` int(11) unsigned NOT NULL auto_increment, `user_name` text, `user_right` int(11) unsigned, `user_mail` text, `userMaps` text, `user_psw` CHAR(40), PRIMARY KEY  (`index`), FULLTEXT (`user_name`))
ENGINE=MyISAM
DEFAULT CHARSET=utf8
COLLATE=latin1_general_ci
AUTO_INCREMENT=1;
